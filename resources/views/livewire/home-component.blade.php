				...
				<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
					...
					<div class="item-slide">
						...
						<div class="slide-info slide-1">
							...
							<p class="sale-info">Giá chỉ: <span class="price">{{$slide->price}}vnđ</span></p>
			...
			<div class="wrap-banner style-twin-default">
				<div class="banner-item">
					<a href="#" class="link-banner banner-effect-1">
						<figure><img src="{{asset('assets/images/mid.jpg')}}" alt="" width="580" height="190"></figure>
					</a>
				</div>
				<div class="banner-item">
					<a href="#" class="link-banner banner-effect-1">
				...
				<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
					...
					<div class="product product-style-2 equal-elem ">
						...
						<div class="product-info">
							...
							<div class="wrap-price"><ins><p class="product-price">{{$sproduct->sale_price}}vnđ</p></ins><del><p class="product-price">{{$sproduct->regular_price}} vnđ</p></del></div>
						</div>
					</div>	
					@endforeach	
				</div>
			...
			<div class="wrap-show-advance-info-box style-1">
				...
				<div class="wrap-top-banner">
					<a href="#" class="link-banner banner-effect-2">
						<!--<figure><img src="{{asset('assets/images/bg.jpg')}}" width="1170" height="240" alt=""></figure>-->
					</a>
				</div>
									...
									@endphp
										...
										<div class="product product-style-2 equal-elem ">
											...
											<div class="product-info">
												...
												<div class="wrap-price"><span class="product-price">{{$c_product->regular_price}}vnđ</span></div>
											</div>
										</div>
										@endforeach																	
								</div>								
