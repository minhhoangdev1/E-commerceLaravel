            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{route('admin.coupons')}}" class="btn btn-success pull-right" >Tất cả giảm giá</a>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" wire:submit.prevent="updateCoupon">
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="">Code giảm giá</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="">Kiểu giảm giá</label>
                            <div class="col-md-4">
