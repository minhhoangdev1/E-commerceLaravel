         ...
         <div class="summary summary-checkout">
            <div class="summary-item payment-method">
               ...
               @if(Session::has('checkout'))
                  <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">{{Session::get('checkout')['total']}} vnđ</span></p>
               @endif
            ...
            <div class="summary-item shipping-method">
               ...
               <p class="summary-info"><span class="title">Fixed 0 vnđ</span></p>
